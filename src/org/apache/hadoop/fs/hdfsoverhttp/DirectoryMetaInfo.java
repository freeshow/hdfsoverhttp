...
public class DirectoryMetaInfo {
	...
	public void setFileNameMaxLength(int fileNameBytesLength,int fileNameCharLength) {
		int len = fileNameCharLength;
		if(fileNameBytesLength > fileNameCharLength){
			len = fileNameBytesLength - (fileNameBytesLength - fileNameCharLength)/2;
		}
	 ...
	 * @return blank string
	 */
	static public String createBlankTag(int fileNameMaxLength,int fileNameBytesLength,int fileNameCharLength){
