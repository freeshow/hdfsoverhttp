...
public class SysConfig {
     ...
     * @throws IOException
     */
	static private Properties getProps(ServletContext context) throws IOException{
		Properties props = new Properties();
		InputStream inputStream=context.getResourceAsStream("/WEB-INF/conf/" + CONF_FILE);
